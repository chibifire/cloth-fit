...
spec load_garment_info(garment_path :: string) :: {:ok :: label, info :: payload} | {:error :: label, reason :: string}
spec load_avatar_info(avatar_path :: string) :: {:ok :: label, info :: payload} | {:error :: label, reason :: string}
